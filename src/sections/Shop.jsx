  ...
  return (
    <Section ref={ref} id="shop">
      ...
      <Right data-scroll ref={Horizontalref}>
        <Product img={img1} title="PORTFOLIO" />
        <Product img={img2} title="AUTOGESTIÓN" />
        <Product img={img3} title="VECINO COSTERO" />
        <Product img={img4} title="CO-DESARROLLO" />
        <Product img={img5} title="SISCO" />
        <Product img={img6} title="FATURI" />
      </Right>
    </Section>
  );
};
